                    ...
                    <div className="qa-sideNav-content  pt-3">
                        <div className="qa-sideNav-menu">
                            <Nav vertical className="qa-menu">
                                ...
                                <NavItem
                                    style={{display: this.autoriseModule("ADD_COMPANY", user?.role)}}>
                                    <NavLink
                                        tag={RRNavLink}
                                        activeClassName="active"
                                        exact
                                ...
                                <NavItem
                                    style={{display: this.autoriseModule("VIEW_COMPANY", user?.role)}}>
                                    <NavLink
                                        tag={RRNavLink}
                                        activeClassName="active"
                                        exact
                                ...
                                <NavItem
                                    style={{display: this.autoriseModule("CREATE_JUNIOR", user?.role)}}>
                                    <NavLink
                                        tag={RRNavLink}
                                        activeClassName="active"
                                        exact
                                ...
                                <NavItem
                                    style={{display: this.autoriseModule("USER_LIST", user?.role)}}>
                                    <NavLink
                                        tag={RRNavLink}
                                        activeClassName="active"
                                        exact
                                ...
                                <NavItem
                                    style={{display: this.autoriseModule("CONVERT_JR_SR", user?.role)}}>
                                    <NavLink
                                        tag={RRNavLink}
                                        activeClassName="active"
                                        exact
                                ...
                                <NavItem
                                    style={{display: this.autoriseModule("POST_QUESTION", user?.role)}}>
                                    <NavLink
                                        tag={RRNavLink}
                                        activeClassName="active"
                                        exact
                                ...
                                <NavItem
                                    style={{display: this.autoriseModule("VIEW_QUESTION", user?.role)}}>
                                    <NavLink
                                        tag={RRNavLink}
                                        activeClassName="active"
                                        exact
                                ...
                                <NavItem
                                    style={{display: this.autoriseModule("APPROVE_ANSWER", user?.role)}}>
                                    <NavLink
                                        tag={RRNavLink}
                                        activeClassName="active"
                                        exact
